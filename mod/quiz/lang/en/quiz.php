...
$string['autosaveconversiondefault'] = 'Auto-save to full default';
$string['autosaveconversiondefault_desc'] = 'If auto-save to full save is enabled by default';
...
$string['autosaveconversionenabled'] = 'Auto to full save conversion';
$string['autosaveconversionenabled_help'] = 'Automatically converts auto-saves to full saves if the time since the last full save has exceeded the administrator defined time limit';
$string['responsereplayenabled'] = 'Response replay';
...
$string['quiz:setautosaveconversion'] = 'Configure auto-save conversion';
