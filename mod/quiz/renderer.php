...
class mod_quiz_renderer extends plugin_renderer_base {
    ...
    public function connection_warning() {
        ...
        $autosavewarning = format_text(get_string('autosaveconversionoutofsequencewarning', 'quiz'), FORMAT_MARKDOWN, $options);
        return html_writer::tag('div', $warning,
                    ...
                    html_writer::tag('div', $autosavewarning, array('id' => 'autosave-warning', 'style' => 'display: none;', 'role' => 'alert'));
    }
}
