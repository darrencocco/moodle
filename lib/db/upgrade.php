...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2016052301.09) {
        ...
        $indexold = new xmldb_index('questionattemptid-sequencenumber', XMLDB_INDEX_UNIQUE,
            array('questionattemptid', 'sequencenumber', 'savetype'));
        $indexnew = new xmldb_index('questionattemptid-sequencenumber-savetype', XMLDB_INDEX_UNIQUE,
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2016052301.09);
    }
