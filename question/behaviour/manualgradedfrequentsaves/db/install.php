 ...
 * Post-install script
 */
function xmldb_qbehaviour_manualgradedfrequentsaves_install() {
    ...
    if (array_search('manualgradedfrequentsaves', $disabledbehaviours) === false) {
        $disabledbehaviours[] = 'manualgradedfrequentsaves';
